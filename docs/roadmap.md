...
Clio aims for a practical middle ground: focused, minimal, and fast.  

Development follows a pragmatic, minimal-core approach.  
...
- [ ] humans.txt generation **(Status: Backlog)**
  Generate a `/humans.txt` file containing author and contributor information.
